const GOOGLE_API_KEY = "AIzaSyArpm64rcfFkL0MC2eOFlkzLYXMLiq4VyU"
...
export const YOUTUBE_SEARCH_SUGGESTION_API = "http://suggestqueries.google.com/complete/search?output=firefox&ds=yt&q="
...
export const YOUTUBE_COMMETS_API = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet,replies&key=${GOOGLE_API_KEY}&videoId=`
